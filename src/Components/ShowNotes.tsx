...
export default function ShowNotes() {
 ...
 rounded-xl me-4 w-[200px] justify-self-end`}>
            <div className={`flex justify-center   me-4 } duration-700 transition-all origin-top  ${mode?"bg-white":"bg-[rgb(0,17,67)]"} p-2 w-full h-16 rounded-t-lg`}><button className={`w-full p-2 text-center transition-all duration-700 border-b-2 ${mode?"border-white":"border-[rgb(0,17,67)]"}  border-solid ${mode?"hover:border-black":"hover:border-white"} `} onClick={()=>{
              setShow(!show)
            }}>Edit note</button></div>
            <div className={`flex justify-center   me-4 } duration-700 transition-all origin-top  ${mode?"bg-white":"bg-[rgb(0,17,67)]"} p-2 w-full h-16 rounded-b-lg`}><button className={`w-full p-2 text-center transition-all duration-700 border-b-2 ${mode?"border-white":"border-[rgb(0,17,67)]"}  border-solid ${mode?"hover:border-black":"hover:border-white"} `}onClick={()=>{
              setDeletePopup(true)
