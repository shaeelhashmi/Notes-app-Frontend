...
export default function Registration() {
  ...
  return (
    <div className='grid min-h-screen grid-cols-1 lg:grid-cols-2 color' >
    <div className=' text-white  p-14 w-[550px]  border-black lg:border-dotted lg:border-r-2 h-full '>
