  ...
  return (
    <div className="flex items-center mt-8">
      ...
      <input 
        ...
        className={`w-[63%] p-3 text-sm bg-[rgb(255,255,255)] border-l-0 border-r-0 border-t-0 border-b text-black placeholder-black placeholder-opacity-70 ${props.border}`}
